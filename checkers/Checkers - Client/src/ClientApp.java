...
public class ClientApp extends JFrame {
	...
	public ClientApp() {
		...
		try {
			...
			//address = "192.168.122.214";     // Connect using the IP address
			
			address = pm.getAddress();
			port = pm.getPort();

			String name = (String) JOptionPane.showInputDialog(null, "Player Name Please:", "Connect to Server",
			...
			if (name != null && name.length() > 0) {
				...
				JOptionPane.showMessageDialog(null, "This name is invalid! Please try again", "Error", JOptionPane.ERROR_MESSAGE,
						null);
				System.exit(0);
			}
		} catch (Exception ex) {
			JOptionPane.showMessageDialog(null, "Unable to connect! Please enter a valid IP address:", "Error", JOptionPane.ERROR_MESSAGE,
					null);
			System.exit(0);
		}
